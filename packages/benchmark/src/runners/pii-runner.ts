...
/**
 * Calculate metrics from classification counts
 */
...
export async function runPiiBenchmark(
  ...
  for (const [category, entries] of Object.entries(piiDatasetByCategory)) {
