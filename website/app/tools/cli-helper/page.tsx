...
const commands = {
  ...
  db: {
    command: 'npx @waymakerai/aicofounder-cli db',
  ...
  analyze: {
    command: 'npx @waymakerai/aicofounder-cli analyze',
                  ...
                  <>
                    <div>
                      ...
                      <div className="code-block font-mono text-sm">
                        npx @waymakerai/aicofounder-cli init my-agent
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-foreground-secondary mb-2">
                      ...
                      <div className="code-block font-mono text-sm">
                        npx @waymakerai/aicofounder-cli init my-agent --template chatbot
                      </div>
                    </div>
                  </>
                )}
                ...
                {selectedCommand === 'check' && (
                  <>
                    <div>
                      ...
                      <div className="code-block font-mono text-sm">
                        npx @waymakerai/aicofounder-cli check
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-foreground-secondary mb-2">
                      ...
                      <div className="code-block font-mono text-sm">
                        npx @waymakerai/aicofounder-cli check --fix
                      </div>
                    </div>
                  </>
                )}
                ...
                {selectedCommand === 'db' && (
                  <>
                    <div>
                      ...
                      <div className="code-block font-mono text-sm">
                        npx @waymakerai/aicofounder-cli db migrate
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-foreground-secondary mb-2">
                      ...
                      <div className="code-block font-mono text-sm">
                        npx @waymakerai/aicofounder-cli db status
                      </div>
                    </div>
                  </>
                )}
                ...
                {selectedCommand === 'deploy' && (
                  <>
                    <div>
                      ...
                      <div className="code-block font-mono text-sm">
                        npx @waymakerai/aicofounder-cli deploy --prod
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-foreground-secondary mb-2">
                      ...
                      <div className="code-block font-mono text-sm">
                        npx @waymakerai/aicofounder-cli deploy --preview
                      </div>
                    </div>
                  </>
                )}
                ...
                {selectedCommand === 'analyze' && (
                  <>
                    <div>
                      ...
                      <div className="code-block font-mono text-sm">
                        npx @waymakerai/aicofounder-cli analyze
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-foreground-secondary mb-2">
                      ...
                      <div className="code-block font-mono text-sm">
                        npx @waymakerai/aicofounder-cli analyze --security
                      </div>
                    </div>
                  </>
                )}
