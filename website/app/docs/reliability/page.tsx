...
const features = [
  {
    ...
    code: `import { withRetry, RetryConfig } from '@waymakerai/aicofounder-core';
...
const client = createClient({
  ...
  },
  {
    ...
    code: `import { CircuitBreaker } from '@waymakerai/aicofounder-core';
...
console.log(breaker.stats);  // { failures: 3, successes: 10, ... }`,
  },
  {
    ...
    code: `import { FallbackChain } from '@waymakerai/aicofounder-core';
...
console.log(result.provider);  // Which provider succeeded`,
  },
  {
    ...
    code: `import { withTimeout, TimeoutError } from '@waymakerai/aicofounder-core';
...
const result = await withTimeout(
  ...
  },
  {
    ...
    code: `import { RateLimiter } from '@waymakerai/aicofounder-core';
...
const result = await limiter.execute(
  ...
  },
  {
    ...
    code: `import { HealthChecker } from '@waymakerai/aicofounder-core';
