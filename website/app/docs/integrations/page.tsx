...
const integrations = [
  {
    ...
    code: `import { HuggingFaceProvider } from '@waymakerai/aicofounder-integrations/huggingface';
...
const agent = new Agent({
  ...
  },
  {
    ...
    code: `import { SupabaseVectorStore } from '@waymakerai/aicofounder-integrations/supabase';
...
const rag = new RAGPipeline({
  ...
  },
  {
    ...
    code: `import { WandBIntegration } from '@waymakerai/aicofounder-integrations/wandb';
...
const comparison = await wandb.compareRuns(['run-1', 'run-2']);`,
  },
  {
    ...
    code: `import { SentryIntegration } from '@waymakerai/aicofounder-integrations/sentry';
...
agent.use(sentry.middleware());`,
  },
  {
    ...
    code: `import { BedrockProvider } from '@waymakerai/aicofounder-integrations/aws-bedrock';
...
for await (const chunk of stream) {
  ...
  },
  {
    ...
    code: `import { MCPClient, MCPServer } from '@waymakerai/aicofounder-integrations/mcp';
      ...
      <div className="container-wide">
        ...
        >
          ...
          <div className="mt-4 code-block font-mono text-sm">
            npm install @waymakerai/aicofounder-integrations
          </div>
        </motion.div>
