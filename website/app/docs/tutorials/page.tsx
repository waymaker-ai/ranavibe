...
import { Agent } from '@waymakerai/aicofounder-core';
import { streamResponse } from '@waymakerai/aicofounder-helpers';
...
import { RAGPresets, SemanticChunker } from '@waymakerai/aicofounder-rag';
...
import { classify, summarize, generate } from '@waymakerai/aicofounder-helpers';
      ...
      <div className="container-wide">
        ...
        >
          ...
          <p className="text-lg text-foreground-secondary">
            Step-by-step tutorials to build real-world AI applications with CoFounder.
