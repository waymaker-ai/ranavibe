...
const features = [
  {
    ...
    code: `import { optimizePrompt, compressPrompt } from '@cofounder/core';
...
const optimized = await optimizePrompt(prompt, {
  ...
  },
  {
    ...
    code: `import { detectHallucinations } from '@cofounder/core';
...
if (result.hasHallucinations) {
  ...
  },
  {
    ...
    code: `import { scoreConfidence, isConfident } from '@cofounder/core';
...
console.log(score.recommendations);`,
  },
  {
    ...
    code: `import { verifyFacts, extractClaims } from '@cofounder/core';
...
console.log(result.overallReliability); // 0-1 score`,
  },
  {
    ...
    code: `import { scoreQuality, getQualityLevel } from '@cofounder/core';
...
console.log(quality.suggestions); // Improvement recommendations`,
  },
  {
    ...
    code: `import { analyzeResponse, isTrustworthy } from '@cofounder/core';
