...
const tiers = [
  {
    ...
    icon: Sparkles,
    features: [
      'All CoFounder packages (@waymakerai/aicofounder-helpers, @waymakerai/aicofounder-prompts, @waymakerai/aicofounder-rag)',
      '25+ CLI commands',
  ...
  },
  {
    ...
    price: '$29',
    period: '/month',
    description: 'We provide the API tokens - You focus on building',
    icon: Rocket,
    features: [
      'Everything in Open Source',
      'API tokens included ($50/month value)',
      'No need to manage API keys',
      'Priority support via email',
      'Advanced analytics dashboard',
      'Private Discord channel',
      'Monthly office hours',
      'Waymaker.cx integration',
    ],
    cta: 'Start Free Trial',
    ctaLink: 'https://waymaker.cx/pricing',
    highlighted: true,
    badge: 'Best Value',
  },
  {
