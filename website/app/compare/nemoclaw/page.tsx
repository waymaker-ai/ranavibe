...
export const metadata = {
  title: 'CoFounder vs NemoClaw / OpenClaw - Comparison',
  description: 'Compare CoFounder guardrails with NVIDIA NemoClaw and the OpenClaw ecosystem',
};
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="mx-auto max-w-4xl px-6 py-24">
        ...
        <p className="text-xl text-gray-400 mb-12">
          ...
          CoFounder provides the same guardrail capabilities — and more — for <strong className="text-white">any</strong> agent
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          ...
          <div className="rounded-xl border border-blue-800/50 bg-blue-900/10 p-6">
            <h3 className="text-lg font-semibold text-blue-400 mb-4">CoFounder Stack</h3>
            <div className="space-y-3 text-sm text-gray-300">
              ...
              <div className="text-center text-gray-500">&darr;</div>
              <div className="p-3 rounded bg-blue-800/20 border border-blue-700/50">
                <strong>@cofounder/agent-sdk</strong> — 7 interceptors, compliance factories
              </div>
              <div className="text-center text-gray-500">&darr;</div>
              <div className="p-3 rounded bg-blue-800/20 border border-blue-700/50">
                <strong>@cofounder/guard</strong> — zero-dep PII, injection, cost, rate-limit
              </div>
              <div className="text-center text-gray-500">&darr;</div>
              <div className="p-3 rounded bg-blue-800/20 border border-blue-700/50">
                <strong>@cofounder/policies</strong> — 9 compliance presets (HIPAA, GDPR, SEC...)
              </div>
              <div className="text-center text-gray-500">&darr;</div>
              <div className="p-3 rounded bg-blue-800/20 border border-blue-700/50">
                <strong>@cofounder/dashboard</strong> — observability, alerts, Prometheus
              </div>
        ...
        <h2 className="text-2xl font-bold mb-6">What CoFounder Adds Beyond NemoClaw</h2>
        ...
        {/* Code example */}
        <h2 className="text-2xl font-bold mb-6">Guardrailing OpenClaw with CoFounder</h2>
        <p className="text-gray-400 mb-4">
          CoFounder can be used as a guardrail layer for OpenClaw agents, similar to what NemoClaw does
