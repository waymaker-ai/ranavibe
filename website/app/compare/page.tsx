        ...
        <div className="grid md:grid-cols-2 gap-8">
          {comparisons.map((comparison) => (
            <Link
              ...
              className="group card block p-8 hover:border-foreground/10 transition-all"
            >
              ...
              <p className="text-lg gradient-text mb-2">{comparison.tagline}</p>
              <p className="text-foreground-secondary">{comparison.description}</p>
            </Link>
          ))}
        </div>

        <div className="mt-16 card p-8 bg-gradient-subtle">
