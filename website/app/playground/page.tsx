...
const MODEL_PRICING: { model: string; provider: string; inputPer1k: number; outputPer1k: number; color: string }[] = [
...
export function estimateCost(text: string): CostEstimate[] {
  // Rough estimate: 1 token ~= 4 characters, assume output is ~1.5x input
