...
**Day 1: Foundation & Core Frameworks**
| Time | Module | Topics |
|------|--------|--------|
...
**Day 2: Advanced Frameworks & Production**
| Time | Module | Topics |
|------|--------|--------|
...
| 4:00-5:00 | Final Project | Build, deploy, present |
| 5:00-5:30 | Certification | Certificate ceremony, next steps |

### What You'll Build
- ✅ Full-stack AI application with authentication
...
- Consultants and agency developers
...
**Week 1: Deep Foundations**
| Session | Topics | Deliverable |
|---------|--------|-------------|
| Live 1 | Architecture deep-dive, CLI mastery, environment setup | Simple app with auth |
| Self-Paced | Database & Security guides, exercises | |
| Live 2 | Database patterns, security best practices, RLS | Secure app deployed |

**Week 2: Advanced Features**
| Session | Topics | Deliverable |
|---------|--------|-------------|
| Live 3 | LLM optimization, cost reduction, multi-model orchestration | AI-powered feature |
| Self-Paced | LLM, SEO, Mobile guides | |
| Live 4 | SEO automation, mobile-first patterns, PWA | Optimized app |

**Week 3: Production Application**
| Session | Topics | Deliverable |
|---------|--------|-------------|
| Live 5 | Final project requirements, architecture planning | Project proposal |
| Self-Paced | Build final project | |
| Live 6 | Mid-project review, code review, debugging | 70% complete project |

**Week 4: Completion & Certification**
| Session | Topics | Deliverable |
|---------|--------|-------------|
| Live 7 | Performance optimization, security hardening, deployment | Production deploy |
| Self-Paced | Complete project, documentation, exam prep | |
| Live 8 | Presentations, certification exam, graduation | Certificate earned |
...
**Certification Exam:**
- 50 questions (multiple choice + code review)
- 1 hour time limit
- 80% to pass
...
- Product companies scaling AI development
...
### Sample 2-Week Enterprise Program
...
| Benefit | Description |
|---------|-------------|
| **Career Advancement** | Stand out with official AI development certification |
| **Verified Skills** | Demonstrate production-ready AI development expertise |
| **Network** | Join community of certified developers |
| **Job Access** | Get listed in certified developer directory |
| **Continuous Learning** | Lifetime access to updates and office hours |

### For Teams
| Benefit | Description |
|---------|-------------|
| **Faster Development** | 120x faster AI application development |
...
| Benefit | Description |
|---------|-------------|
| **ROI** | Measurable productivity and cost improvements |
| **Risk Reduction** | Security and compliance built-in |
| **Talent Development** | Upskill existing team |
| **Competitive Advantage** | Ship AI features faster than competitors |
| **Scalability** | Framework scales with your team |
...
### Teaching Philosophy
- **70% Hands-On:** Learn by building real applications
- **Production Focus:** Everything deploys to production
- **Immediate Feedback:** Live code reviews and guidance
- **Progressive Complexity:** Build on previous knowledge
- **Peer Learning:** Collaborate with fellow developers
...
2. **Contact us:**
   - Email: training@waymaker.cx
   - Website: https://waymaker.cx/training
   - Calendar: https://cal.com/waymaker/training
3. **Complete registration** and payment
4. **Receive access** to pre-course materials
5. **Attend training** and earn your certification
...
A: Certifications don't expire, but we recommend recertification when major versions release.

**Q: Can I take the exam without training?**
A: Currently, the exam is only available as part of the certification program.
