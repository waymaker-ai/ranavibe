      ...
      <section className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
            ...
            <code className="text-xs bg-gray-100 dark:bg-gray-900 px-2 py-1 rounded">aicofounder check pre</code>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
            ...
            <code className="text-xs bg-gray-100 dark:bg-gray-900 px-2 py-1 rounded">aicofounder design-coverage</code>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
            ...
            <code className="text-xs bg-gray-100 dark:bg-gray-900 px-2 py-1 rounded">@waymakerai/aicofounder-mcp-server</code>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg">
            ...
            <code className="text-xs bg-gray-100 dark:bg-gray-900 px-2 py-1 rounded">@waymakerai/aicofounder-sdk</code>
          </div>
