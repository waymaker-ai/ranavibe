...
Demonstrates how `@waymakerai/aicofounder-openclaw` integrates CoFounder guardrails with OpenClaw agents:
...
The OpenClaw runtime is not required to run this demo -- the skill/bridge pattern is demonstrated using the types from `@waymakerai/aicofounder-openclaw`.
