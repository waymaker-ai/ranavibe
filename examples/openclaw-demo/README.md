...
Demonstrates how `@ranavibe/openclaw` integrates RANA guardrails with OpenClaw agents:
...
The OpenClaw runtime is not required to run this demo -- the skill/bridge pattern is demonstrated using the types from `@ranavibe/openclaw`.
