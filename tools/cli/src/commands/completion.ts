...
const COMMANDS = [
  ...
  { name: 'validate', desc: 'Validate .cofounder.yml configuration' },
...
export async function completionCommand(): Promise<void> {
  ...
  console.log(chalk.gray('  cofounder completion:bash >> ~/.bashrc'));
  console.log(chalk.gray('  source ~/.bashrc\n'));

  console.log(chalk.bold('Zsh:'));
  console.log(chalk.gray('  cofounder completion:zsh >> ~/.zshrc'));
  console.log(chalk.gray('  source ~/.zshrc\n'));

  console.log(chalk.bold('Fish:'));
  console.log(chalk.gray('  cofounder completion:fish > ~/.config/fish/completions/cofounder.fish\n'));

  console.log(chalk.bold('Or auto-install for your shell:'));
  console.log(chalk.cyan('  cofounder completion:install\n'));
}
  ...
  try {
    switch (shell) {
      ...
      default:
        ...
        console.log(chalk.gray('  cofounder completion:bash   # for bash'));
        console.log(chalk.gray('  cofounder completion:zsh    # for zsh'));
        console.log(chalk.gray('  cofounder completion:fish   # for fish'));
    }
  } catch (error: any) {
...
# Generated by: cofounder completion:bash
# Add to ~/.bashrc: source <(cofounder completion:bash)
...
# Generated by: cofounder completion:zsh
# Add to ~/.zshrc: source <(cofounder completion:zsh)
...
_cofounder() {
    ...
    case \$state in
        command)
            _describe -t commands 'cofounder commands' commands
            ;;
        args)
            case \$words[2] in
...
# Generated by: cofounder completion:fish
