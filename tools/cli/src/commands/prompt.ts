...
export async function promptCreate(options: {
  ...
  console.log(chalk.cyan(`  cofounder prompt:test ${id}`));
  console.log();
}
...
export async function promptList(options: { verbose?: boolean } = {}) {
  ...
  if (promptsList.length === 0) {
    ...
    console.log(chalk.cyan('  cofounder prompt:create'));
    console.log();
    return;
  }
...
export async function promptTest(promptId: string, options: {
  ...
  if (options.dryRun) {
    ...
    if (execute) {
      ...
      console.log(chalk.gray('Run `cofounder llm:setup` to configure providers.\n'));
    }
  }
 ...
 * Generated by \`cofounder prompt:protect\`
 */
...
export async function promptTemplates() {
  ...
  console.log(chalk.cyan('  cofounder prompt:create --id my-prompt --template "Your template here"'));
  console.log();
}
