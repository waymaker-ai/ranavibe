...
`,
    ...
    dependencies: ['@cofounder/core', '@cofounder/testing'],
    postCreate: [
...
import { RAGPresets, type RAGPipeline } from '@cofounder/rag';
...
`,
    ...
    dependencies: ['@cofounder/core', '@cofounder/rag', '@cofounder/testing'],
    postCreate: [
      '1. Configure your API key: cofounder config:set --provider openai',
...
`,
    ...
    dependencies: ['@cofounder/prompts'],
    postCreate: [
